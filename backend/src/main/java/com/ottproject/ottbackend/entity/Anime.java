...
public class Anime {
    ...
    @ManyToMany(
            ...
            cascade = {CascadeType.MERGE}) // 장르 다대다
    @JoinTable(
    ...
    @ManyToMany(
            fetch = FetchType.LAZY,
            cascade = {CascadeType.MERGE}) // 태그 다대다
    @JoinTable(
    ...
    @ManyToMany(
            fetch = FetchType.LAZY,
            cascade = {CascadeType.MERGE}) // 스튜디오 다대다
    @JoinTable(
    ...
    @ManyToMany(
            fetch = FetchType.LAZY,
            cascade = {CascadeType.MERGE}) // 감독 다대다
    @JoinTable(
    ...
    @ManyToMany(
            fetch = FetchType.LAZY,
            cascade = {CascadeType.MERGE}) // 성우 다대다
    @JoinTable(
    ...
    @ManyToMany(
            fetch = FetchType.LAZY,
            cascade = {CascadeType.MERGE}) // 캐릭터 다대다
    @JoinTable(
