...
public class MembershipController {
    ...
    public ResponseEntity<UserMembershipDto> subscribe(
            @RequestBody MembershipSubscribeRequestDto dto, HttpSession session) { // 요청 바디의 플랜 코드로 구독 신청 처리
    ...
    public ResponseEntity<UserMembershipDto> cancel(
            @RequestBody MembershipCancelMembershipRequestDto dto, HttpSession session) { // 말일 해지 예약(멱등키로 중복 방지)
    ...
    public ResponseEntity<MembershipPlanChangeResponseDto> changePlan(
            @RequestBody MembershipPlanChangeRequestDto request, HttpSession session) {
