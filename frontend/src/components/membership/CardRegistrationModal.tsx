    ...
    >
      ...
      >
        ...
        <div>
          ...
          <h3 style={{ color: "var(--foreground-1, #F7F7F7)" }}>
            간편 결제 등록
          </h3>
          <button
            onClick={onClose}
        ...
        <div>
          <div>
            <h4 style={{ color: "var(--foreground-1, #F7F7F7)" }}>
              카드 정보 입력
            </h4>

            {/* 카드 번호 */}
            <div>
              <label style={{ color: "var(--foreground-1, #F7F7F7)" }}>
                카드 번호
              </label>
              <div>
                <input
                  ...
                  style={{
                    ...
                    borderBottom: "2px solid var(--border-1, #323232)",
