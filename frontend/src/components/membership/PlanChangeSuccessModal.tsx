  ...
  return (
    <div className={styles.modalOverlay}>
      <div className={styles.modalContent}>
        ...
        {/* 성공 메시지 */}
        <h2 className={styles.successTitle}>플랜 변경이 완료되었습니다!</h2>

        {/* 상세 정보 */}
        <div className={styles.successMessage}>
          <p className={styles.mainMessage}>
            다음달부터 <span className={styles.planName}>{planName}멤버십</span>
            을 사용합니다
          </p>
          <p className={styles.dateMessage}>적용일: {formattedDate}</p>
        </div>
