  ...
  return (
    ...
    >
      <div className={styles.container}>
        <h2 id="cancel-membership-title" className={styles.title}>
          멤버십 해지하기
        </h2>
        <p className={styles.desc}>
          멤버십을 해지하면 등급이 초기화되고 아래 혜택들과 프로필 정보를 이용할
          수 없게 돼요. 그래도 해지하시겠어요?
        </p>
        ...
        {isPremium && (
          <div className={styles.profileNotice}>
            ...
            <p>
              위 프로필을 제외한 나머지 프로필은 비활성화 처리되며, 관련된
              정보(등급, 보고싶다, 재생기록 등)을 이용할 수 없게 됩니다.
            </p>
          </div>
        )}

        <p className={styles.purchaseNotice}>
          다운로드, 소장·대여를 포함한 구매내역, 별점, 게시글은 삭제되지
          않습니다.
        </p>
