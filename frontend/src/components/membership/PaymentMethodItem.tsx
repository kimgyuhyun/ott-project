  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center" }}>
        <div
          className={`w-8 h-8 ${colorClass} rounded-full flex items-center justify-center mr-3`}
        >
          {id === "kakao" && (
            <svg
              width="16"
            ...
            >
              ...
              <path
                d="M12 7c-3.59 0-6.5 1.94-6.5 4.33 0 1.58 1.15 2.95 2.9 3.74l-.46 2.76 3.05-2.07h1.01c3.59 0 6.5-1.94 6.5-4.33S15.59 7 12 7z"
                fill="#000000"
              />
            </svg>
          )}
          {id === "toss" && (
            ...
            >
              ...
              <path
                d="M12 5c4.418 0 8 3.134 8 7-5.2-.1-8 3.8-12 0 0-3.866 3.134-7 8-7z"
                fill="#0064FF"
              />
