...
export default function StepByStepRegisterForm({
  onClose,
  onSuccess,
}: StepByStepRegisterFormProps) {
  ...
  const handleVerifyCode = async () => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "인증코드가 올바르지 않습니다.",
      );
    } finally {
      setIsLoading(false);
    }
      ...
      <div>
          ...
          <div>
            <div
              style={{
                ...
                borderRadius: "50%",
                backgroundColor:
                  currentStep === "email" ? "#8b5cf6" : "#d1d5db",
              }}
            ></div>
            <div
              style={{
                ...
                borderRadius: "50%",
                backgroundColor:
                  currentStep === "verification" ? "#8b5cf6" : "#d1d5db",
              }}
            ></div>
            <div
              style={{
                ...
                borderRadius: "50%",
                backgroundColor:
                  currentStep === "password" ? "#8b5cf6" : "#d1d5db",
              }}
            ></div>
          </div>
        </div>
        ...
        {currentStep === "verification" && (
          <div>
            ...
            <div>
              <button onClick={() => setCurrentStep("email")}>이전</button>
              <button
        ...
        {/* 하단 링크 */}
        <div>
          <button onClick={resetForm}>처음부터 다시 시작</button>
        </div>
      </div>
    </div>
  );
