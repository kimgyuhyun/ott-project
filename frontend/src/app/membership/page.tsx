...
export default function MembershipPage() {
  ...
  const handleSubscribe = async () => {
    try {
      ...
      alert(
        `${selectedPlan === "basic" ? "베이직" : "프리미엄"} 멤버십을 시작합니다!`,
      );
      closeModal();
      // 사용자 멤버십 상태 새로고침
      reloadUserMembership();
      ...
      <main>
        ...
        <div className={styles.heroSection}>
          ...
          <video className={styles.heroVideo} autoPlay muted loop playsInline>
            <source
              src="/videos/membership-video-8c63a66100d0e1ca81c56fe752365cbc.mp4"
              type="video/mp4"
            />
          </video>
          ...
          <div className={styles.textContent}>
            <h1 className={styles.mainTitle}>동시방영 신작부터</h1>
            <h2 className={styles.subTitle}>역대 인기작까지 한 곳에서</h2>
            ...
            <div className={styles.noticeSection}>
              ...
              <div className={styles.noticeBox}>
                ...
                <div className={styles.noticeBoxContent}>
                  ...
                  <p>
                    • 미성년자 회원은 법정대리인의 명의 또는 동의를 통해
                    결제해야 하며, 동의 없이 결제된 경우 법정대리인이 이를
                    취소할 수 있습니다.
                  </p>
                  <p>
                  ...
                  <p>
                    • 멤버십 결제 후 디지털 콘텐츠를 하나도 다운로드하지
                    않았고(다운로드 시작 포함), 스트리밍 서비스를 통해 전혀
                    재생하지 않은 경우에 한해, 결제일로부터 7일 이내 라프텔
                    고객센터에 요청하시면 환불 가능합니다. 단, 인앱 결제 또는
                    외부 제휴처를 통해 구독하신 경우, Google Play, App Store, LG
                    U+등 제휴사 고객센터를 통해 환불 요청해 주시기 바랍니다.
                  </p>
                  <p>
                    • 멤버십 이용 중에는 남은 기간에 대한 금액 환불이
                    불가합니다.
                  </p>
                </div>
              </div>
              ...
              {/* 콘텐츠 이용 안내 */}
              <div className={styles.noticeBox}>
                <h3 className={styles.noticeBoxTitle}>콘텐츠 이용 안내</h3>
                <div className={styles.noticeBoxContent}>
                  <p>
                  ...
                  <p>
                    • 다운로드한 콘텐츠는 일정 기간 동안만 시청 가능하며,
                    멤버십이 만료되면 더 이상 이용할 수 없습니다.
                  </p>
                  <p>
                  ...
                  <p>
                    • 콘텐츠 제공사 또는 저작권자의 요청으로 특정 기기에서는
                    일부 콘텐츠 시청이 제한될 수 있습니다.
                  </p>
                </div>
              </div>
              ...
              <div className={styles.noticeBox}>
                ...
                <div className={styles.noticeBoxContent}>
                  ...
                  <p>
                    • 지원하는 스마트폰, 태블릿, TV에서는 라프텔 공식 앱을 설치
                    후 이용 가능합니다.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    루팅되거나 탈옥된 기기, 시스템 설정이 변경된 기기에서는
                    재생이 제한됩니다.
                  </p>
                  <p>
                  ...
                  <p>
                    • 영상 화질은 사용하는 인터넷 환경, 디바이스의 성능 등에
                    따라 달라질 수 있습니다. 모든 콘텐츠가 모든 화질로 동일하게
                    제공되지는 않습니다.
                  </p>
                  <p>
              ...
              {/* 기타 안내 */}
              <div className={styles.noticeBox}>
                <h3 className={styles.noticeBoxTitle}>기타 안내</h3>
                <div className={styles.noticeBoxContent}>
                  <p>
            ...
            <div>
              ...
              >
                <div className={styles.planSelectionCardContent}>
                  ...
                  <div className={styles.planSelectionPrice}>월 9,900원</div>
                </div>
              </div>
              ...
              >
                <div className={styles.planSelectionCardContent}>
                  ...
                  <div className={styles.planSelectionPrice}>월 14,900원</div>
                </div>
              </div>
            </div>
