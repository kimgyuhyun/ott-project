...
export default function MembershipGuidePage() {
  ...
  const summaryCard = (
      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          <h3 className="text-2xl font-bold mb-1" style={{ color: '#111827' }}>베이직</h3>
          <p className="text-lg font-bold mb-2" style={{ color: '#111827' }}>월 9,900원</p>
        </div>
                 <span className="bg-gray-900 text-purple-400 border border-gray-600 text-xs px-2.5 py-1.5 rounded-md font-bold">현재 이용 중 ✓</span>
      </div>

      <div className="mb-4">
        <ul className="space-y-2">
          <li className="flex items-center" style={{ color: '#111827' }}>✓ 프로필 1인·동시재생 1회선</li>
          <li className="flex items-center" style={{ color: '#111827' }}>✓ 최신화 시청</li>
          <li className="flex items-center" style={{ color: '#111827' }}>✓ 다운로드 지원</li>
          <li className="flex items-center" style={{ color: '#111827' }}>✓ FHD 화질 지원</li>
          <li className="flex items-center" style={{ color: '#111827' }}>✓ TV 앱 지원</li>
        </ul>
      </div>

      <div className="flex justify-between items-center">
        <span style={{ color: '#6B7280' }}>2025.09.03 결제 예정</span>
        <Link href="/mypage" className="text-blue-600 hover:underline">내 멤버십 관리 &gt;</Link>
      </div>
    </div>
  );
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
           ...
           <div className="mb-6 relative h-64 rounded-lg overflow-hidden">
             ...
             <div className="relative z-10 flex flex-col justify-center items-center h-full text-center px-6">
               <h1 className="text-3xl md:text-4xl font-bold mb-4 text-white">라프텔 멤버십으로 스마트한 덕질!</h1>
               <p className="text-lg text-gray-200 max-w-2xl">동시방영 신작부터 역대 인기 애니까지 멤버십으로 최애 애니를 마음껏 감상하세요</p>
             </div>
           </div>

                     {/* 성공 배너 */}
           {successMsg && (
             <div className="bg-[#0E0E12] border border-[#2A2A33] rounded-lg p-4 mb-4 text-[#EDEDED]">{successMsg}</div>
           )}

           {/* 오류 배너 */}
           {error && (
                            <div className="bg-[#0E0E12] border border-[#2A2A33] rounded-lg p-4 mb-4 text-[#EDEDED]">
                 멤버십 정보를 불러오지 못했습니다.
                 <button onClick={() => window.location.reload()} className="ml-3 underline">재시도</button>
               </div>
           )}
           ...
           {!isLoading && userMembership ? (
             summaryCard
               ...
               <p className="mb-3">로그인 후 멤버십 상태를 확인할 수 있습니다.</p>
                                <Link href="/login" className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-3 rounded-lg font-bold">로그인하고 멤버십 확인</Link>
             </div>
           )}

                     {/* 다른 멤버십 */}
           <div className="mb-6">
             <h3 className="text-lg font-semibold mb-3 text-gray-600">다른 멤버십</h3>
                            <div className="bg-white border border-gray-200 rounded-lg p-4">
               <div className="flex justify-between items-center">
                 <span style={{ color: '#111827' }}>프리미엄</span>
           ...
           <div className="mb-8 bg-white rounded-lg p-6 border border-gray-200">
             <h2 className="text-2xl font-bold mb-4 text-gray-900">멤버십 유의사항</h2>
            
                         {/* 멤버십 구독 및 결제 안내 */}
             <div className="mb-6">
               <h3 className="text-lg font-semibold mb-3 text-gray-900">멤버십 구독 및 결제 안내</h3>
               ...
               <p>• 멤버십 이용 중에는 남은 기간에 대한 금액 환불이 불가합니다.</p>
                         ...
                         {/* 콘텐츠 이용 안내 */}
             <div className="mb-6">
               <h3 className="text-lg font-semibold mb-3 text-gray-900">콘텐츠 이용 안내</h3>
                            <div className="text-gray-700 text-sm space-y-2">
               ...
               <p>• 일부 콘텐츠는 콘텐츠 제공사 또는 저작권자의 요청에 따라 스트리밍으로만 제공되며, 다운로드 이용이 불가할 수 있습니다.</p>
                         ...
                         {/* 재생 및 이용 환경 안내 */}
             <div className="mb-6">
               <h3 className="text-lg font-semibold mb-3 text-gray-900">재생 및 이용 환경 안내</h3>
                            <div className="text-gray-700 text-sm space-y-2">
               ...
               <p>• 콘텐츠 제공사 또는 저작권자의 요청으로 특정 기기에서는 일부 콘텐츠 시청이 제한될 수 있습니다.</p>
                         ...
                         {/* 기타 안내 */}
             <div>
               <h3 className="text-lg font-semibold mb-3 text-gray-900">기타 안내</h3>
                            <div className="text-gray-700 text-sm space-y-2">
