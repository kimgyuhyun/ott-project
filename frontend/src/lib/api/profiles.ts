...
/** 프로필 이름 변경 */
export async function renameProfile(profileId: number, name: string): Promise<ViewingProfile> {
...
export async function selectProfile(profileId: number): Promise<ViewingProfile> {
